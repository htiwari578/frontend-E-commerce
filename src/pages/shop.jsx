  ...
  return <>
    ...
    <div className ="container-xxl">
      <div className="row justify-content-center align-items-center">
        <div className="offer-details text-center p-6">
          <div>
         
       
            <h1 className='text-white'><span><b>100%</b></span> Off
            on All Products </h1>
        </div>
        <div>
...
<div className="container-xxl">
  <div className="row ">
  <div className="col-12 d-flex aligh-items-center justify-content-center">
